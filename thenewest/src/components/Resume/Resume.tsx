...
const Resume: React.FC<ResumeProps> = ({ activeSection }) => {
  return (
    <>
      <div className="resume-section">
        ...
        <div className="resume-item">
          ...
          <p className="description">implementation systems and customize odoo tools to suit
            the client using python</p>
        </div>
        ...
        <div className="resume-item">
          ...
          <p className="description">IT supporting for the web application that used in mobile
            application for house of colors problem solving and big
            experience in printers systems.</p>
        </div>
        ...
        <div className="resume-item">
          ...
          <p className="description">selling mobile phones and accessories for clients and for
            golden mobile vendors.</p>
        </div>
      </div>
      ...
      <div className="resume-section">
        ...
        <div className="resume-item">
          ...
          <div className="institution">EC-Council</div>
        </div>
      </div>
    </>
  );
